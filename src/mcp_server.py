...
class MCPAcademicServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 1. Gọi dispatch_tool_call từ tools.py để lấy kết quả dạng JSON string
        raw_result_str = dispatch_tool_call(tool_name, arguments)
        
        # 2. Parse chuỗi JSON thành Dict
        result_dict = json.loads(raw_result_str)
        
        # 3. Đóng gói trả về đúng định dạng MCP JSON-RPC 2.0
        return {
            "jsonrpc": "2.0",
